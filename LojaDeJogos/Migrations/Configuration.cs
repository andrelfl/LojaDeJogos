        ...
        protected override void Seed(LojaDeJogos.Models.ApplicationDbContext context)
        {
           var categorias = new List<Categorias> {
            ...
            var media = new List<Media> {
                new Media {ID=1, Fotografia="darkSoulsRemastered1.jpg", JogosFK=1},
                new Media {ID=2, Fotografia="darkSoulsRemastered2.jpg", JogosFK=1},
                new Media {ID=3, Fotografia="darkSoulsRemastered3.jpg", JogosFK=1},
                new Media {ID=4, Fotografia="darkSoulsRemastered4.jpg", JogosFK=1},
                new Media {ID=5, Fotografia="counterStrikeGO1.jpg", JogosFK=2},
                new Media {ID=6, Fotografia="counterStrikeGO2.jpg", JogosFK=2},
                new Media {ID=7, Fotografia="counterStrikeGO3.jpg", JogosFK=2},
                new Media {ID=8, Fotografia="counterStrikeGO4.jpg", JogosFK=2},
                new Media {ID=9, Fotografia="bioshockInfinite1.jpg", JogosFK=3},
                new Media {ID=10, Fotografia="bioshockInfinite2.jpg", JogosFK=3},
                new Media {ID=11, Fotografia="bioshockInfinite3.jpg", JogosFK=3},
                new Media {ID=12, Fotografia="bioshockInfinite4.jpg", JogosFK=3},
                new Media {ID=13, Fotografia="borderlands21.jpg", JogosFK=4},
                new Media {ID=14, Fotografia="borderlands22.jpg", JogosFK=4},
                new Media {ID=15, Fotografia="borderlands23.jpg", JogosFK=4},
                new Media {ID=16, Fotografia="borderlands24.jpg", JogosFK=4},
                new Media {ID=17, Fotografia="rocketLeague1.jpg", JogosFK=5},
                new Media {ID=18, Fotografia="rocketLeague2.jpg", JogosFK=5},
                new Media {ID=19, Fotografia="rocketLeague3.jpg", JogosFK=5},
                new Media {ID=20, Fotografia="rocketLeague4.jpg", JogosFK=5},
                new Media {ID=21, Fotografia="fallout41.jpg", JogosFK=6},
                new Media {ID=22, Fotografia="fallout42.jpg", JogosFK=6},
                new Media {ID=23, Fotografia="fallout43.jpg", JogosFK=6},
                new Media {ID=24, Fotografia="fallout44.jpg", JogosFK=6},
                new Media {ID=25, Fotografia="witcher31.jpg", JogosFK=7},
                new Media {ID=26, Fotografia="witcher32.jpg", JogosFK=7},
                new Media {ID=27, Fotografia="witcher33.jpg", JogosFK=7},
                new Media {ID=28, Fotografia="witcher34.jpg", JogosFK=7},
                new Media {ID=29, Fotografia="payday21.jpg", JogosFK=8},
                new Media {ID=30, Fotografia="payday22.jpg", JogosFK=8},
                new Media {ID=31, Fotografia="payday23.jpg", JogosFK=8},
                new Media {ID=32, Fotografia="payday24.jpg", JogosFK=8},
                new Media {ID=33, Fotografia="cuphead1.jpg", JogosFK=9},
                new Media {ID=34, Fotografia="cuphead2.jpg", JogosFK=9},
                new Media {ID=35, Fotografia="cuphead3.jpg", JogosFK=9},
                new Media {ID=36, Fotografia="cuphead4.jpg", JogosFK=9}
